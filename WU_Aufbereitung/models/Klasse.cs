...
namespace WU_Aufbereitung.models
{
    class Klasse
    {
        ...
        public static List<Schueler> GetSampleSchuelerListe() {
            ...
            liste.Add(new Schueler("Hubach", "Jean-Pierre", new Fehlzeit[] { new Fehlzeit("02.11", 8, "entschuldigt"), new Fehlzeit("02.11", 8, "entschuldigt"), new Fehlzeit("02.11", 8, "entschuldigt"), new Fehlzeit("02.11", 8, "entschuldigt"), new Fehlzeit("02.11", 8, "entschuldigt"), new Fehlzeit("02.11", 8, "entschuldigt") }));
            liste.Add(new Schueler("Beyer", "Tilman", new Fehlzeit[] { new Fehlzeit("03.11", 4, "entschuldigt"), null, null, null, null }));
            liste.Add(new Schueler("Schuck", "Christian", new Fehlzeit[] { new Fehlzeit("04.11", 8, "offen"), null, null, null, null }));
            liste.Add(new Schueler("Sperling", "Oliver", new Fehlzeit[] { new Fehlzeit("04.11", 3, "beurlaubt"), null, null, null, null }));
            liste.Add(new Schueler("Mucke", "Philipp", new Fehlzeit[] { new Fehlzeit("04.11", 2, "entschuldigt"), null, null, null, null }));
